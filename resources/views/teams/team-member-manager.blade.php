<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                <x-slot name="title">
                    @lang('teams/teams.add_members.title')
                </x-slot>

                <x-slot name="description">
                    @lang('teams/teams.add_members.description')
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            @lang('teams/teams.add_members.explication')
                        </div>
                    </div>

                    <!-- Member Email -->
                    <div class="col-span-6 sm:col-span-4">
                        <x-jet-label for="email" value="{{ __('teams/teams.add_members.email') }}" />
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-jet-label for="role" value="{{ __('teams/teams.add_members.role') }}" />
                ...
                <x-slot name="actions">
                    <x-jet-action-message class="mr-3" on="saved">
                        @lang('teams/teams.button.added')
                    </x-jet-action-message>

                    <x-jet-button>
                        @lang('teams/teams.button.add')
                    </x-jet-button>
                </x-slot>
            </x-jet-form-section>
        </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                <x-slot name="title">
                    @lang('teams/teams.pending_invitations.title')
                </x-slot>

                <x-slot name="description">
                    @lang('teams/teams.pending_invitations.description')
                </x-slot>
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                <x-slot name="title">
                    @lang('teams/teams.manage_members.title')
                </x-slot>

                <x-slot name="description">
                    @lang('teams/teams.manage_members.description')
                </x-slot>
    ...
    <x-jet-dialog-modal wire:model="currentlyManagingRole">
        <x-slot name="title">
            @lang('teams/teams.manage_roles.title')
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingLeavingTeam">
        <x-slot name="title">
            @lang('teams/teams.leave_team.title')
        </x-slot>

        <x-slot name="content">
            @lang('teams/teams.leave_team.description')
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        <x-slot name="title">
            @lang('teams/teams.remove_member.title')
        </x-slot>

        <x-slot name="content">
            @lang('teams/teams.remove_member.description')
        </x-slot>
